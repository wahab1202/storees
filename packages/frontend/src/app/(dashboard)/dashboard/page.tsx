...
// Phosphor icons (aliased to prior lucide names) — icon-refresh prototype.
import { Info, Pulse as Activity, CaretUp as ChevronUp, CaretDown as ChevronDown, Brain, ArrowRight, Users, ChartPie as PieChart, Megaphone, FlowArrow as Workflow } from '@phosphor-icons/react'
